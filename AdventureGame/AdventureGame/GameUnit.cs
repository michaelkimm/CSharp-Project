...
namespace AdventureGame
{
    abstract class GameUnit
    {
        ...
        public GameUnit(PictureBox pictureBox, Label unitLabel, Point pose, int speed, int initialHitPoint, int power)
        {
        ...
        public GameUnit(PictureBox pictureBox, Label unitLabel, int x, int y, int speed, int initialHitPoint, int power)
        {
            unitPictureBox = pictureBox;
            this.unitLabel = unitLabel;
        ...
        //public abstract void Attack(EnumClass.MoveDir dir);
